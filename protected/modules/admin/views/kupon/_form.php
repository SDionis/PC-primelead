...
$text="  Добавить категорию";
 echo CHtml::link(CHtml::encode($text), 'kategoriya/create', array('target'=>'_blank')); ?>
<div id="subcat_0"></div>
...
$text="Добавить магазин";
 echo CHtml::link(CHtml::encode($text), "http://test.raido.biz.ua/good-click/index.php/admin/shop/create", array('target'=>'_blank')) ;?>
