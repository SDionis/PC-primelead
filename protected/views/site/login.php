...
?>
	...
	'clientOptions'=>array(
		...
		<?php echo $form->textField($model,'username', array('placeholder'=>'Имя пользователя','class'=>'input-block-level')); ?>
		<?php echo $form->error($model,'username'); ?>
						...
						<div class="controls">
                            ...
                            <small><a href="#forget-pass" role="button" data-toggle="modal">Вы забыли ваш пароль?</a></small>
						</div>
